...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(gr => new { DeptNo = gr.Key, Count = gr.Count() }); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        // I HAVENT UNDERSTOOD WHY WE NEED SELECT MANY HERE, bc we don`t have any list in our emp. data so now my Ename in anom.class
        // is divided into char(like char[]). I dont know is it right...
        var result = emps.Where(e => e.Comm != null).SelectMany(e => e.EName, (e, Comm) => new {e.EName, Comm});
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps.SelectMany(e => grades.Where(s=> s.Losal <= e.Sal && e.Sal <= s.Hisal).Select(s => new {e.EName,s.Grade}));
